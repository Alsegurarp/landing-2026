  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="sm-logo flex items-center select-none pointer-events-auto cursor-pointer" aria-label="Logo" onClick={handleLogoClick} role="button" tabIndex={0} onKeyDown={(e) => e.key === 'Enter' && handleLogoClick()}>
            <img
